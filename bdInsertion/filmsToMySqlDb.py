    ...
    try:
        ...
        for line in file:
            ...
            if lineSplitted[0] == "tconst":
                ...
                cur.execute(statement, (lineSplitted[0], lineSplitted[1], lineSplitted[2], lineSplitted[3], lineSplitted[4],
                lineSplitted[5], lineSplitted[6], lineSplitted[7], lineSplitted[8]))
                conn.commit()
